...
[Serializable] public class CarryState { public int protocol=10,clueMask,phase=-1,credits,receipt,returnPay,tick,holder=-1,ack,players; public int recipient,occupiedMask=1; public UnityEngine.Vector3[] positions; public float[] yaws; public UnityEngine.Vector3 p0,p1,cargo; public UnityEngine.Quaternion rotation; public int beaconCarrier=-1; public bool beaconExists; public bool receiptCollected,receiptReady; public float receiptProgress; public float yaw0,yaw1,shiftElapsed; public int suppressionStage; public ThreatState outerDanger; public bool unlocked,hard; public int deliveries,charges; public float beaconTime; public UnityEngine.Vector3 beaconPosition; public bool hazard; public ThreatState danger; public ThreatState[] additionalDanger; public bool connected; public string message,rejection; }
}
