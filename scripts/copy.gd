...
const STRINGS := {
	...
	"development": ["DEVELOPMENT PROTOTYPE / 0.7.1\nLocal / LAN connection · Steam invites not connected", "개발용 프로토타입 / 0.7.1\n로컬·LAN 연결 · Steam 친구 초대 미연결"],
	...
	"prototype": ["NO RETURNS / DEVELOPMENT 0.7.1", "반품 불가 / 개발용 0.7.1"],
