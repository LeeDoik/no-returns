...
**현재 버전: 배송 신전 플레이테스트 0.7.5 · 2026년 9월 8일**
...
로컬 Git으로 관리하며 0.5/0.6 기준점을 보존합니다. 이번 변경의 식별자는 `v0.7.5`이며 GitHub 원격 저장소는 연결하지 않습니다. [변경 기록·복구 안내](docs/development/version-control.ko.md), [문서 작성 규칙](AGENTS.md)을 참고하세요.
