...
[새 구조 모델·실측·검증 상태](ship-interior-trial.ko.md). 평평한 바닥과 중앙 화면을 실제 별도 Blender 모델로 제작했다. 구조 표본과 GLB 검사는 통과했지만 중앙 창틀 시야가 남아 있고 Unity 라이선스 오류로 게임 검증·빌드는 미완료다. 기존 모델 보존.
