...
A separate demo connects delivery, receipt, return and supplies on the primitive CINDER map. This is not final art or release sign-off; the 10–15-minute target awaits human validation.
