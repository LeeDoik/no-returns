...
Conveyor: flush with floor, centered (10, -10), width 2.2 m, length 6 m. Forward points toward negative Z. Speed 2 m/s, lever at (12, 0, -9), interaction range 2.4 m. F reverses it, with a .5-second shared cooldown, server distance/facing/line-of-sight checks and no requirement to release held cargo. Workers receive external belt velocity; free grounded cargo approaches belt velocity, excluding held, recovering and attached cargo. Guests only present replicated state. Reset forward each shift and clear movement outside play.
